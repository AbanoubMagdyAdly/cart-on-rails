...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { expire_at: @coupon.expire_at, percentage: @coupon.percentage } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { expire_at: @coupon.expire_at, percentage: @coupon.percentage } }
